...
const CAIXA_SHOPS = [
  ...
  { id: "casapalha", name: "Casa de Palha", cat: "restaurante", where: "Estrada do Coco, km 5 · Pitangueiras", since: "2008", wa: "5571991680888", zap: true, waNote: "WhatsApp no site", tel: "7133691151", site: "https://www.casadepalha.com.br/", ident: "Tem site", ajuda: "SEO", ajudaLinha: "Já tem site (casadepalha.com.br) e WhatsApp. Ajuda: um cardápio só, que cai no Zap, e busca ‘restaurante Estrada do Coco / Vilas’. Não construir outra casa.", gap: "Cardápio enorme. Precisa de um caminho único no celular.", build: ["seo", "whats", "posts"], next: "Mostrar o caminho único. Não abrir um site novo." },
  { id: "camaraovilas", name: "Camarão Vilas", cat: "restaurante", where: "Av. Praia de Itapuã, 805", wa: "5571982005212", zap: true, waNote: "WhatsApp na publicação · reserva", insta: "@camaraovilas", ident: "Tem Instagram", tel: "7140094949", ajuda: "Conteúdo", ajudaLinha: "Já reserva no WhatsApp. Ajuda: conteúdo do prato e collab de movimento na avenida. SEO só se, na porta, a busca ‘camarão Vilas’ não cair neles.", gap: "Frutos do mar. Pedido e reserva têm que caber no telefone.", build: ["posts", "whats"], next: "Almoço de terça. Dono ou gerente. Não vender site se a reserva já fecha." },
  { id: "caranguejo", name: "Boteco do Caranguejo", cat: "bar", where: "Av. Praia de Itapuã, 893", insta: "@botecodocaranguejo", wa: "5571997098380", zap: false, quase: true, waNote: "celular de pedido no guia. A palavra WhatsApp não está. Fora da fila até confirmar.", tel: "7133635151", ajuda: "Collab", ajudaLinha: "Já está no Google, tem Instagram e pedido no Zap. Ajuda: collab de movimento — noite ao vivo com a orla. Conteúdo da semana se quiserem ritmo. Não é site novo.", gap: "Petisco de orla. Turista pesquisa ‘caranguejo Vilas’.", build: ["posts"], next: "Fim de tarde, antes da noite. Falar de movimento, não de obra." },
  ...
  { id: "popularvet", name: "Clínica Popular Vet", cat: "pet", where: "R. José H. Requião · dentro da Agromix", insta: "@popularvett", ident: "Tem Instagram", wa: "5571984878338", zap: true, waNote: "WhatsApp publicado · Bahia Notícias", ajuda: "Site", ajudaLinha: "Instagram e WhatsApp de agendamento. Site próprio não achei. Ajuda: casa no celular com o 24h, o endereço da Agromix e o botão que já é este Zap. Não é outro hospital.", recado: "Oi. Aqui é o Yan, de Vilas. Vi o WhatsApp da Popular Vet. Quem precisa de noite ainda procura no Google antes de ter o número. Posso te mostrar em 40 segundos, sem trocar o Zap?", liga: "Oi, aqui é o Yan. Achei o WhatsApp da Popular Vet. Quarenta segundos: a casa no celular pra quem precisa de noite. Posso te mostrar agora?", gap: "Tutor pesquisa de madrugada. O Zap existe. A casa no Google pode não existir.", build: ["site", "google", "whats"], next: "Ligar. Se cair na recepção, pedir quem decide. Abrir a demo. Não falar plano." },
  { id: "cmdvilas", name: "Correios Vilas · CMD", cat: "loja", where: "Av. Luiz Tarquínio Pontes, 2272 · ao lado do Mix", insta: "@correiosvilasdoatlantico", ident: "Tem Instagram", wa: "5571920015806", zap: true, waNote: "WhatsApp no Instagram", ajuda: "Site", ajudaLinha: "Balcão franqueado. Instagram e WhatsApp publicados. Site próprio não achei. Ajuda: horário, o que o balcão faz e o botão. Se quem atende não decide, anota o nome e segue.", recado: "Oi. Aqui é o Yan. Vi o WhatsApp do Correios de Vilas. O horário está no Instagram. Quem não segue ainda pergunta. Posso te mostrar em 40 segundos uma casa simples?", liga: "Oi, aqui é o Yan. Vi o WhatsApp de vocês. Quarenta segundos: horário e botão numa casa, sem trocar o balcão. Posso te mostrar?", gap: "Quem precisa do horário ainda depende do Instagram.", build: ["site", "google", "whats"], next: "Ligar. Se for funcionário, pedir o responsável da loja. Não prometer o site dos Correios." },
  { id: "cardosoramos", zona: "lauro", name: "Cardoso Ramos Imobiliária", cat: "loja", where: "R. Porto Alegre, 318 · Centro, Lauro de Freitas", site: "http://www.cardosoramos.com.br/", ident: "Tem site", wa: "5571983421900", zap: true, waNote: "WhatsApp no site · CRECI 1823-J", tel: "7130272222", ajuda: "SEO", ajudaLinha: "Já tem site e WhatsApp. Ajuda: a busca de imóvel em Vilas cair nesta casa, com a mesma cara. Não construir outro site.", recado: "Oi. Aqui é o Yan, em Lauro. Vi o site da Cardoso Ramos e o WhatsApp. Quem pesquisa imóvel em Vilas ainda pode não cair em vocês. Posso te mostrar em 40 segundos, sem trocar o site?", liga: "Oi, aqui é o Yan. Vi o site e o WhatsApp de vocês. Não é outro site. É a busca cair na casa que já existe. Quarenta segundos. Posso te mostrar?", gap: "A casa existe. Quem pesquisa Vila pode cair em outro anúncio.", build: ["seo", "google", "posts"], next: "Ligar no Zap. Falar com quem cuida do site, não com o plantão de visita." },

  { id: "carolnutrii", name: "CarolNutrii Vilas", cat: "restaurante", where: "R. Praia de Tubarão, 196 · Giovanni Center", site: "https://www.carolnutrii.com.br/", ident: "Tem site", cel: "71991877688", quase: true, ajuda: "SEO", ajudaLinha: "Tem site. O post marca WhatsApp no (71) 99259-2335, que é a unidade da Costa Azul. O delivery de Vilas está como 99187-7688, sem a palavra WhatsApp. Não ligar como Zap até confirmar este número.", gap: "Comida saudável com casa no ar. A unidade de Vilas precisa do botão certo.", build: ["seo", "whats"], next: "Não entra na fila. Passar na loja e pedir o Zap desta unidade." },
  { id: "montanari", name: "Cantina Montanari Vilas", cat: "restaurante", where: "Av. Luiz Tarquínio Pontes, 2128", cel: "71981048987", tel: "7135080282", quase: true, ajuda: "Conteúdo", ajudaLinha: "Rodízio na avenida. Reserva de aniversário no celular (71) 98104-8987 e fixo 3508-0282. A palavra WhatsApp não está. Fora da fila.", gap: "Casa grande. O celular de reserva ainda não está marcado como Zap.", build: ["posts", "whats"], next: "Não ligar como Zap. Se passar na porta, pedir o número certo." },
  { id: "lafontana", name: "La Fontana", cat: "restaurante", where: "Av. Praia de Itapuã, Q.15, L.39 · cita também Abrantes", cel: "71986357047", quase: true, insta: "Facebook La Fontana Vilas", ajuda: "Site", ajudaLinha: "Mais de 20 anos em Vilas. Celular na página. O domínio pizzarialafontana.com.br abre outra cidade. Não usar esse site como deles. Palavra WhatsApp não achei.", gap: "A casa é antiga. O site que aparece no nome não é o de Vilas.", build: ["site", "google"], next: "Fora da fila. Na porta, confirmar qual número é o Zap e se a unidade de Abrantes é a mesma." },
  { id: "granpepe", name: "Gran Pepe Pizza", cat: "restaurante", where: "R. Praia de Mar Grande, 1790 · loja 09", cel: "719999416150", quase: true, ajuda: "Site", ajudaLinha: "Delivery de pizza. O guia traz (71) 99941-6150 como telefone. A palavra WhatsApp não está. Fora da fila.", gap: "Pedido no celular. Sem casa confirmada e sem Zap confirmado.", build: ["site", "whats", "google"], next: "Não ligar ainda. Confirmar na porta se esse celular abre no WhatsApp." }
];
...
const PACK_VILAS = {
  ...
  person: {
    ...
    facts: [
      ...
      "Duas portas a pé: Se Plante (Matinê, sem número discável) e Lounge Vilas (inbound).",
      "Fila de ligação: só número em que a fonte escreveu WhatsApp. Fixo não é Zap. Celular sem a palavra fica de fora.",
