...
const LOJA = [
  { id: "caneta", name: "Caneta de grife", price: "Sob consulta", note: "Escrita e presença", img: "assets/img/loja/caneta.jpg" },
  { id: "gravata", name: "Gravata", price: "Sob consulta", note: "Autoridade visual", img: "assets/img/loja/gravata.jpg" },
  { id: "joia", name: "Joia / acessório", price: "Sob consulta", note: "Detalhe high-ticket", img: "assets/img/loja/joia.jpg" },
  { id: "colar", name: "Colar", price: "Sob consulta", note: "Peça assinatura", img: "assets/img/loja/colar.jpg" },
  { id: "top1", name: "Top macramê creme", price: "Sob consulta", note: "Macramê", img: "assets/img/loja/top-creme.jpg" },
  { id: "top2", name: "Top macramê mostarda", price: "Sob consulta", note: "Macramê", img: "assets/img/loja/top-mostarda.jpg" }
];
...
function viewTreino() {
  const chakras = [
    ["01","Base","assets/img/treino/chakra-01.jpg"],
    ["02","Sacral","assets/img/treino/chakra-02.jpg"],
    ["03","Plexo","assets/img/treino/chakra-03.jpg"],
    ["04","Cardíaco","assets/img/treino/chakra-04.jpg"],
    ["05","Laríngeo","assets/img/treino/chakra-05.jpg"],
    ["06","Frontal","assets/img/treino/chakra-06.jpg"],
    ["07","Coronário","assets/img/treino/chakra-07.jpg"]
  ];
  return `<div class="view active">${back()}
    <p class="hero-line">Complementar</p>
    <h2 class="hero-title">Treino e exercícios</h2>
    <p class="hero-sub">Fundamentos: consistência &gt; intensidade esporádica. Painel visual dos 7 vetores.</p>
    <div class="treino-grid">${chakras.map(([n,name,src]) =>
      `<figure><img src="${src}" alt="${name}"><figcaption>${n} · ${name}</figcaption></figure>`
    ).join("")}</div>
    <div class="mat-grid">
...
function viewLoja() {
  return `<div class="view active">${back()}
    ...
    <div class="mat-grid">${LOJA.map(
      ...
      <img class="shop-ph-img" src="${p.img}" alt="${esc(p.name)}">
      <h4>${esc(p.name)}</h4>
      <p>${esc(p.price)}</p>
