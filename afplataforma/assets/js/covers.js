...
export const COVER_SLOTS = [
  { id: "dash", label: "Dashboard · head", fallback: "assets/img/banners/dash.webp" },
  { id: "modules", label: "Módulos · head", fallback: "assets/img/banners/modules.webp" },
  ...
  { id: "tools", label: "Ferramentas · head", fallback: "assets/img/banners/tools.webp" },
  ...
  { id: "call", label: "Call · head", fallback: "assets/img/banners/call.webp" },
  { id: "profile", label: "Perfil · head", fallback: "assets/img/lua/perfil/lua-perfil-01.webp" },
  { id: "complementar", label: "Complementar · head", fallback: "assets/img/banners/complementar.webp" },
  { id: "quitei", label: "Quitei · head", fallback: "assets/img/banners/quitei.webp" },
  ...
  { id: "constelacao", label: "Constelação · head", fallback: "assets/img/banners/constelacao.webp" },
  { id: "dicionario", label: "Dicionário · head", fallback: "assets/img/banners/dicionario.webp" },
