/**
 * Presença AF — online / offline / na call
 * Fonte: afPresence/{uid}  heartbeat 25s
 */
...
function photoOf() {
  ...
  return prof.photo || (session.role === "mentor" ? "assets/img/mentor/yan.jpg" : "");
}
...
export async function startPresence() {
  ...
  await beatOnce(false);
  clearInterval(beat);
  beat = setInterval(() => beatOnce(false), 25000);
